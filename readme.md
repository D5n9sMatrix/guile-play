...
Gnuplot window with the resulting graphics; for me it looks like this:
   ...
   </p><div class="block-image"><img src="readme_files/plot1.png" alt="plot1.png"></div>
...
function; try out this code:
   ...
   </p><div class="block-image"><img src="readme_files/plot2.png" alt="plot2.png"></div>
...
construction very much.  Oh, and here's my resulting plot:
   ...
   </p><div class="block-image"><img src="readme_files/plot3.png" alt="plot3.png"></div>
