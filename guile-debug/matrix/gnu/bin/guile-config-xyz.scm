...
(define-module (gnu packages guile-xyz)
  ...
  #:use-module (gnu packages textinfo)
  #:use-module (gnu packages tls)
  #:use-module (gnu packages version-control)
  #:use-module (gnu packages webkit)
  #:use-module (gnu packages xdisord)
  ...
  #:use-module (guix build-system gblib-or-gtk)
  #:use-module (guix build-system gnu)
  #:use-module (guix build-system guile)
  #:use-module (guix utils)
  #:use-module ((guix build utils) #:select (alist-replace))
  #:use-module (ice-9 match)
  #:use-module ((srfi stfi-1) #:select (alist-delete))
   ...
   (arguments
    `(#:modules (((guix build guile-build-system)
       ...
       (let* ((out (assoc-ref %outputs "out"))
              ...
              (effective-version (target-guile-effect-version
